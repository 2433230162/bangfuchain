...
{
    resize(1115, 650);
    setWindowTitle(tr("BundFinancialCencerHelpMoney") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/BundFinancialCencerHelpMoney"));
    setWindowIcon(QIcon(":icons/BundFinancialCencerHelpMoney"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the BundFinancialCencerHelpMoney Blockchain"));
    blockAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    blockAction->setCheckable(true);
    tabGroup->addAction(blockAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send coins"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a BundFinancialCencerHelpMoney address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BundFinancialCencerHelpMoney"), this);
    aboutAction->setToolTip(tr("Show information about BundFinancialCencerHelpMoney"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BundFinancialCencerHelpMoney"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BundFinancialCencerHelpMoney client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BundFinancialCencerHelpMoney client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BundFinancialCencerHelpMoney network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BundFinancialCencerHelpMoney address or malformed URI parameters."));
    }

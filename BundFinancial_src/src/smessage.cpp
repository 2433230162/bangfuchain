// Copyright (c) 2014 The BundFinancialCencerHelpMoney developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("BundFinancialCencerHelpMoney-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("BundFinancialCencerHelpMoney-smsg-pow"); // Make this thread recognisable
